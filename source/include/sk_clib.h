...
typedef __sklib_ptr __sklib_conversation;
...
typedef __sklib_ptr __sklib_motor_device;
typedef __sklib_ptr __sklib_servo_device;
...
typedef int __sklib_language_model;
